...
#
# ActiveState ActiveTcl 8.5.6.0.289025 Win32/x86, Wed Jan 28 12:01:31 PST 2009
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1233172891}
	buildtime,fmt {Wed Jan 28 12:01:31 PST 2009}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.6.0.289025 Win32/x86 @ Wed Jan 28 12:01:31 PST 2009 / normal}
    }
}

package provide {ActiveTcl} {8.5.6.0.289025}
